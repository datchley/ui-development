...
describe('Values and Types', () => {
    ...
    it('\'this\' in methods refers the object context', () => {
        ...
        // Using the same Person object from the previous test, Ensure
        ...
        // In browser, 'this' would be defined inside function and it
        ...
        expect(me instanceof Person).toBe(true);
        expect(me.whoami()).toBe("River");
        expect(whoami()).toBe("Jane");
    });

    //
    // Doesn't work in node, setup for browser
    //
    xit('\'eval\' can modify scope and is bad (1)', () => {
        ...
        // Call show with a declaration of 'b' that satisfies the tests
        show("var b = 3", 1);
    });
    ...
    it('\'eval\' can modify scope and is bad (2)', () => {
        ...
        // Call 'show()' with a string declaration of 'b' that satisfies the tests
        show("b = 3", 1);
        expect(b).toBe(3);
    });
    ...
    it('\'eval\' can modify scope and is bad (3)', () => {
        ...
        // Call 'show()' with a string declaration of 'a' that passes the test
        show("var a = 3");
    });
});
